...
function showResult(){
	...
	if (selfAwareScore >= 35 && selfAwareScore <=50){ // if user scored more than 3
        //creating a new span tag and passing the user score number and total question number
		let scoreTag1 = '<span><p>Self Awareness Score:  '+ selfAwareScore +' (This EQ area is a strength for you) </p> </span>';
        scoreText.innerHTML = scoreTag1;  //adding new span tag inside score_Text
    }
    else if(selfAwareScore >= 18 && selfAwareScore <= 34){ // if user scored more than 1
		let scoreTag1 = '<span><p>Self Awareness Score:  '+ selfAwareScore +' (This EQ area needs a bit of improvement from you) </p> </span>';
        scoreText.innerHTML = scoreTag1;
    }
    else{ // if user scored less than 1
        let scoreTag1 = '<span><p>Self Awareness Score:  '+ selfAwareScore +' (You need to work more on this EQ area) </p> </span>';
        scoreText.innerHTML = scoreTag1;
    }
	
	 if (manageEmoScore >= 35 && manageEmoScore <=50){ // if user scored more than 3
        //creating a new span tag and passing the user score number and total question number
		let scoreTag2 = '<span><p>Managing Emotions Score: '+ manageEmoScore +' (This EQ area is a strength for you) </p> </span>';
        scoreText2.innerHTML = scoreTag2;  //adding new span tag inside score_Text
    }
    else if(manageEmoScore >= 18 && manageEmoScore <= 34){ // if user scored more than 1
	let scoreTag2 = '<span><p>Managing Emotions Score: '+ manageEmoScore +' (This EQ area needs a bit of improvement from you) </p> </span>';
        scoreText2.innerHTML = scoreTag2;
    }
    else{ // if user scored less than 1
	 let scoreTag2 = '<span><p>Managing Emotions Score:  '+ manageEmoScore +' (You need to work more on this EQ area) </p> </span>';
        scoreText2.innerHTML = scoreTag2;
    }
	
	if (motivateOneScore >= 35 && motivateOneScore <=50){ // if user scored more than 3
        //creating a new span tag and passing the user score number and total question number
		let scoreTag3 = '<span><p>Motivating Oneself Score: '+ motivateOneScore +' (This EQ area is a strength for you) </p> </span>';
        scoreText3.innerHTML = scoreTag3;  //adding new span tag inside score_Text
    }
    else if(motivateOneScore >= 18 && motivateOneScore <= 34){ // if user scored more than 1
	let scoreTag3 = '<span><p>Motivating Oneself Score: '+ motivateOneScore +' (This EQ area needs a bit of improvement from you) </p> </span>';
        scoreText3.innerHTML = scoreTag3;
    }
    else{ // if user scored less than 1
	let scoreTag3 = '<span><p>Motivating Oneself Score: '+ motivateOneScore +' (You need to work more on this EQ area) </p> </span>';
        scoreText3.innerHTML = scoreTag3;
    }
	
	if (empathyScore >= 35 && empathyScore <=50){ // if user scored more than 3
        //creating a new span tag and passing the user score number and total question number
		let scoreTag4 = '<span><p>Empathy Score: '+ empathyScore +' (This EQ area is a strength for you) </p> </span>';
        scoreText4.innerHTML = scoreTag4;  //adding new span tag inside score_Text
    }
    else if(empathyScore >= 18 && empathyScore <= 34){ // if user scored more than 1
	let scoreTag4 = '<span><p>Empathy Score: '+ empathyScore +' (This EQ area needs a bit of improvement from you) </p> </span>';
        scoreText4.innerHTML = scoreTag4;
    }
    else{ // if user scored less than 1
	let scoreTag4 = '<span><p>Empathy Score: '+ empathyScore +' (You need to work more on this EQ area) </p> </span>';
	...
	if (socialSkillsScore >= 35 && socialSkillsScore <=50){ // if user scored more than 3
	   ...
	   let scoreTag5 = '<span><p>Social Skills Score '+ socialSkillsScore +' (This EQ area is a strength for you) </p> </span>';
        scoreText5.innerHTML = scoreTag5;  //adding new span tag inside score_Text
    }
    else if(socialSkillsScore >= 18 && socialSkillsScore <= 34){ // if user scored more than 1
         let scoreTag5 = '<span><p>Social Skills Score '+ socialSkillsScore +' (This EQ area needs a bit of improvement from you) </p> </span>';
        scoreText5.innerHTML = scoreTag5;
    }
    else{ // if user scored less than 1
	let scoreTag5 = '<span><p>Social Skills Score '+ socialSkillsScore +' (You need to work more on this EQ area) </p> </span>';
        scoreText5.innerHTML = scoreTag5;
    }
}
